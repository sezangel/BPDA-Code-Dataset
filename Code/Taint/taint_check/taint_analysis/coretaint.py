...
class CoreTaint:
	...
	debug=False
        ...
        for r in set_regs:
            ...
            try:
                mem_cnt = tmp_s.memory.load(reg_cnt, 50)  
            ...
            try:
				...
				print "***** Not in functrace addr 0x%x"%self.get_addr(current_path)
			        ...
			        for i in xrange(nargs):
					    ...
					    if (callNextIns.insn.insn_name()=='str' and callNextIns.insn.op_str.startswith('r0')) or (callNextIns.insn.insn_name()=='mov' and callNextIns.insn.op_str.endswith('r0')) or (callNextIns.insn.insn_name()=='sub' and callNextIns.insn.op_str.endswith('r0, 
